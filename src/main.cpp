...
public:
    void init()
    {
        ...
        GPIOD->MODER |= ( GPIO_MODER_MODER12_0 | GPIO_MODER_MODER13_0 |
                          GPIO_MODER_MODER15_0 ); // Устанавливаем как выход (01)
        ...
        GPIOD->OSPEEDR |= ( GPIO_OSPEEDER_OSPEEDR12 | GPIO_OSPEEDER_OSPEEDR13 |
                            GPIO_OSPEEDER_OSPEEDR15 ); // Максимальная скорость (11)

        GPIOD->PUPDR &= ~( GPIO_PUPDR_PUPDR12 | GPIO_PUPDR_PUPDR13 | GPIO_PUPDR_PUPDR15 ); // Сбрасываем биты
        GPIOD->PUPDR |=
            ( GPIO_PUPDR_PUPDR12_1 | GPIO_PUPDR_PUPDR13_1 | GPIO_PUPDR_PUPDR15_1 ); // Pull-down (10)
